...
public class ConditionRequest
{
    ...
    public List<string>? UserNames { get; set; }            // Gửi theo username

    // === THEO LỚP ===
    public List<string>? ClassCodes { get; set; }           // VD: ["TH27.25", "TR26.10"]

    // === THEO KHOA ===
    public List<string>? FacultyCodes { get; set; }         // VD: ["TH", "TR"] 
